...
#also, might want to avoid rotating the mrc by itself - you might
##    want to make sure it is locked in with the other models and
##    only move the ccp4 relative to the rest
