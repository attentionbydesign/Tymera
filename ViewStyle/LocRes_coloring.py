###script for expanded variety of colors for local resolution
# maps with larger ranges of resolution / high heterogeneity
# automates selection of gradient colors
